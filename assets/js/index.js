const data = {
  people: ['premiér', 'babiš', 'ministr zdravotnictví', 'mynistr vnitra', 'ministr školství', 'hamáček', 'plaga'],
  peoplePhrases: [
    'otevření škol ve stupni $level systému pes si nedovedu představit',
    'registrace lidí pod 80 let se odsouvá',
    'očkocat by se nechalo 58 % dotazovaných',
    ...
    've stupni $level systému pes ještě nejakou dobu zůstaneme',
    ...
    'vláda v pondělí pozádá sněmovnu o prodloužení nouzového stavu o $days dní',
    'vláda v úterý pozádá sněmovnu o prodloužení nouzového stavu o $days dní',
    'vláda ve středu pozádá sněmovnu o prodloužení nouzového stavu o $days dní',
    'vláda ve čtvrtek pozádá sněmovnu o prodloužení nouzového stavu o $days dní',
    'vláda v pátek pozádá sněmovnu o prodloužení nouzového stavu o $days dní',
    'zmírnění opatření se nedá v příštím týdnu očekévat',
    's řadou poměrně tvrdách opatření jde počítat přibličně do $date',
  ],
  phrases: [
    'němocko zařadilo českou republiku na seznam rizikových oblastí',
    ...
    'v české republice byl potvrzen výskyt nakažlější britské mutace',
    'od úterý budou moci otevřít papírnictví, obchody s dětským oblečením a obuví. Obchody se spodnám prádlem nebudou moci otevřít',
    'je reálná šance, že se maturanti do škol vrátí až $date',
    'laboratoř má podezření na výskyt nakažlivějsí britské mutace',
